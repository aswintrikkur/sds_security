    ...
    return (
        <>
            <section>
                ...
                <img className="absolute right-0 bottom-4/12 w-4/12 max-w-72" src="/images/Vector-cam.png" alt="" />
            </section>
            ...
            <section>
                <SectionTitle
                    ...
                    description={"Connect with us today for a tailored security solution."}
                >
                    <Link to={"/contact"}>
                        <PrimaryButton>Contact Us</PrimaryButton>
                    </Link>
